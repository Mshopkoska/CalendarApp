...
namespace CALENDAR.Helpers
{
    ...
    {
        public static string GetEventListJSONString(List<CALENDAR.Entity.Event> events)
        {
        ...
        public static string GetResourceListJSONString(List<CALENDAR.Entity.Location> locations)
        {
